...
use App\Domain\Models\Conditions\LtCondition;
use Carbon\Carbon;
use PHPUnit\Framework\Attributes\DataProvider;
use Tests\TestCase;

final class LtConditionTest extends TestCase
{
    public static function rightData(): array
    {
        return [
            ...
            'float' => [1.1, 1.2],
            'bool' => [false, true],
            'date' => [Carbon::parse('2022-01-01'), Carbon::parse('2022-02-01')],
        ];
    }
    ...
    public function testIsSatisfied(mixed $value, mixed $limit): void
    {
        ...
        $this->assertTrue(app(LtCondition::class, compact('condition', 'value'))->isSatisfied());
    }
    ...
    public function testIsNotSatisfied(mixed $value, mixed $limit): void
    {
        ...
        $this->assertFalse(app(LtCondition::class, compact('condition', 'value'))->isSatisfied());
    }
}
